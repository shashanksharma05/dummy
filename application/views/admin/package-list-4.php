                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Patent Package</h4>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="panel panel-border panel-info">
                            <div class="panel-heading row">
                                <h4 class="m-t-0 header-title">PATENT PACKAGE </h4>
                            </div>
                            <hr style="margin:0;">
                        ...
                        <div class="card-box package-edit hidden">
                            ...
                            <form action="" class="form-horizontal" method="post" enctype="multipart/form-data">
                                <div class="form-body">
                                    ...
                                    <?php $additional = !empty($Data[0]->AdditionalPrice)?json_decode($Data[0]->AdditionalPrice,true):'';
                                    if(!empty($additional)){ foreach ($additional as $key => $value) { ?>
                                    <div class="form-group">
                                        <label class="control-label col-md-4">
                                            <?php echo $value['label']; ?> Price
                                        </label>
                                        <div class="col-md-4">
                                            <input type="number" class="form-control" name="label<?php echo $key; ?>" value="<?php echo $value['price']; ?>" step=".01" required>
                                        </div>
                                    </div>
                                    <?php } } ?>
                                    <div class="form-group">
                                        <label class="control-label col-md-4">Full Patent Registration Price
                                        </label>
                                        <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-4">Package Tax
                                        </label>
                                        <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-4">Package Fee
                                        </label>
                                        <div class="col-md-4">
