                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Trademark Classes</h4>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="panel panel-border panel-info">
                            <div class="panel-heading row">
                                <h4 class="m-t-0 header-title pull-left">ALL TRADEMARK CLASSES LIST </h4>
                                <button type="button" class="m-b-10 btn btn-info pull-right addNew">Add New Class</button>
                            </div>
                            <hr style="margin:0;">
                                ...
                                <table class="table table-colored table-centered table-info m-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="gradeX">
                                            ...
                                            <td class="class"><?php echo $package->packageClass; ?></td>
                                            ...
                                            <td><?php if($package->DateUpdate){ echo date('d-m-Y',$package->DateUpdate); } ?></td>
                        ...
                        <div class="card-box package-edit hidden">
                            ...
                            <form action="" class="form-horizontal" method="post" enctype="multipart/form-data">
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3">Package Class
                                        </label>
                                        <div class="col-md-4">
                                            <input type="number" class="form-control" name="packageClass" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
...
<script>
    $(document).ready(function() {        
        ...
        $('.edit-row').on('click',function() {
            ...
            var pclass = edit.find('td.class').text();
            ...
            $('[name="packagePrice"]').val(price.trim());$('[name="packageClass"]').val(pclass.trim());
        ...
        $('.addNew').on('click',function() {
            ...
            $('[name="packagePrice"]').val('');$('[name="packageClass"]').val('');
