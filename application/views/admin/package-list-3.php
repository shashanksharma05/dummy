                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Copyright Packages</h4>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="panel panel-border panel-info">
                            <div class="panel-heading row">
                                <h4 class="m-t-0 header-title pull-left">ALL COPYRIGHT PACKAGES LIST </h4>
                                <button type="button" class="m-b-10 btn btn-info pull-right addNew">Add New Package</button>
                            </div>
                            <hr style="margin:0;">
