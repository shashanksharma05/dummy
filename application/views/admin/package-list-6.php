                        ...
                        <div class="page-title-box">
                            <div class="btn-group pull-right">
                                <ol class="breadcrumb hide-phone p-0 m-0">
                                    ...
                                    <li class="active">
                                        Mandatory Compliance Packages
                                    </li>
                                </ol>
                            </div>
                            <h4 class="page-title">Mandatory Compliance Packages</h4>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="panel panel-border panel-info">
                            <div class="panel-heading row">
                                <h4 class="m-t-0 header-title">ALL MANDATORY COMPLIANCE PACKAGES LIST </h4>
                            </div>
                            <hr style="margin:0;">
                                ...
                                <table class="table table-colored table-centered table-info m-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="gradeX">
                                            ...
                                            <td class="tax"><?php echo !empty($additional['price'])?$additional['price']:'-' ?></td>
                                            ...
                                            <td class="actions" data-dsc="<?php echo !empty($additional['price'])?$additional['price']:'' ?>">
                        ...
                        <div class="card-box package-edit hidden">
                            ...
                            <form action="" class="form-horizontal" method="post" enctype="multipart/form-data">
                                <div class="form-body">
                                    ...
                                    <div class="form-group dsc" style="display: none;">
                                        <label class="control-label col-md-3">DSC ( Digital Signature)
                                        </label>
                                        <div class="col-md-4">
                                            <input type="number" class="form-control" name="dsc" step=".01">
                                        </div>
                                    </div>
                                    <div class="form-group">
